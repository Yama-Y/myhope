		...
		<fieldset>
			...
			<table class="table" style="width: 100%;">
				...
				<tr>
					...
					<th>资源类型</th>
					<td><select name="data.resourcetype.id" class="easyui-combobox" data-options="required:true,editable:false,valueField:'id',textField:'name',url:'<%=contextPath%>/base/resourcetype!doNotNeedSecurity_combobox.myhope',panelHeight:'auto'" style="width: 155px;"></select></td>
				</tr>
				<tr>
					<th>上级资源</th>
					<td><select id="resource_id" name="data.resource.id" class="easyui-combotree" data-options="editable:false,idField:'id',textField:'text',parentField:'pid',url:'<%=contextPath%>/base/resource!doNotNeedSecurity_getMainMenu.myhope'" style="width: 155px;"></select><img class="iconImg ext-icon-cross" onclick="$('#resource_id').combotree('clear');" title="清空" /></td>
					<th>资源图标</th>

...
<script type="text/javascript">
	var submitForm = function($dialog, $grid, $pjq) {
		...
		$.post(myhope.contextPath + '/schedule!grantOrganization.myhope', {
	...
	$(function() {
		...
		$('#tree').tree({
			...
			onLoadSuccess : function(node, data) {
				$.post(myhope.contextPath + '/base/organization!doNotNeedSecurity_getOrganizationByScheduleId.myhope', {
					id : $(':input[name="data.id"]').val()
				}, function(result) {
					if (result) {
